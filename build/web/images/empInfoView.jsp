      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets/img/blurred-image-1.jpg">
       ...
       <div class="cont">
            <table class="table">
                ...
                <tr><th>First Name</th><td><%=u.getFname()%></td></tr>
                <tr><th>Last Name</th><td><%=u.getLname()%></td></tr>
                ...
                <tr><th>Marks in 10th</th><td><%=u.getMarks10()%></td></tr>
                <tr><th>Marks in 12th</th><td><%=u.getMarks12()%></td></tr>
                <tr><th>CGPA in College</th><td><%=u.getCgpa()%></td></tr>
                <tr><th>School in 10th</th><td><%=u.getSchool10()%></td></tr>
                <tr><th>School in 12th</th><td><%=u.getSchool12()%></td></tr>
                <tr><th>College</th><td><%=u.getCollege()%></td></tr>
                <tr><th>About Me</th>
                    <td><%=u.getCabout()%></td></tr>
